...
public class Extractor {
    ...
    @SneakyThrows
    public DailyTemperatureDto getTemperatureAt(City city, LocalDate date) {
    ...
    public static void main(String[] args) throws IOException {
        DailyTemperatureDto temp = new Extractor().getTemperatureAt(City.ODESSA, LocalDate.of(2011, 1, 2));

        log.info("Start getting content html page");
        Connection connection = Jsoup.connect("https://meteo.ua/archive/111/odessa/2011-1-2");
        Document document = connection.get();
